...
![mUAS_DAQ_Figure](https://github.com/user-attachments/assets/e5a905c7-baca-44d1-a848-7223435591e5)
...
A python-based data acquisition program for a remote sensing platform integrating multiple sensor payload on a unmanned aerial vehicle (UAV) for structural behavior monitoring and environmental feature collection under multi-hazards. For more details about the design of the mUAS and the data/results collected by this unique platform, please refer to the following publications:
